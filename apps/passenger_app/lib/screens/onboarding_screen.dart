      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: RadialGradient(
            ...
            radius: 1.3,
            colors: [
              Color(0xFF0D2530), // Subtle teal glow
              Color(0xFF070E1A),
              Color(0xFF04070D),
            ],
          ),
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: const Color(0xFF2DC79F).withOpacity(0.3)),
                      ),
                      child: const Row(
                        children: [
                          Icon(Icons.local_taxi_rounded, color: Color(0xFF2DC79F), size: 14),
                          SizedBox(width: 6),
                          Text(
                            'GIGA RIDE',
                            style: TextStyle(
                      ...
                      child: Center(
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              _images[i],
                              fit: BoxFit.contain, // Fits completely without any cropping or zoom
                        ...
                        return AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: active
                                ? [
                                    BoxShadow(
                                      color: const Color(0xFF2DC79F).withOpacity(0.5),
                                      blurRadius: 8,
                                    ),
                                  ]
                                : null,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          elevation: 6,
                          shadowColor: const Color(0xFF2DC79F).withOpacity(0.45),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(16),
                          ),
                        ),
