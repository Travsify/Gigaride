...
/// Mandatory Location Gate for Giga Driver.
/// Prevents drivers from entering the dispatch cockpit until precise GPS location is active.
...
class _LocationPermissionGateState extends State<LocationPermissionGate>
  ...
  String _detectedArea = 'Locking Driver Radar GPS Coordinates in Nigeria...';
  ...
  /// Automatically re-verifies permission when driver switches back from phone Settings
  @override
  ...
  Future<void> _onPermissionGranted() async {
    ...
    try {
      ...
      try {
        ...
        if (mounted && address.isNotEmpty && address != 'Current Location') {
          ...
          if (mounted) {
            setState(() {
              _detectedArea =
                  'Driver Radar GPS Active (${pos.latitude.toStringAsFixed(3)}°N, ${pos.longitude.toStringAsFixed(3)}°E)';
            });
          }
        }
      } catch (_) {
      ...
      if (mounted) {
        setState(() {
          _detectedArea = 'Driver Radar GPS Connected (Nigeria)';
        });
      }
    }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Connecting with Nigerian road telemetry',
            style: TextStyle(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    isApple
                        ? 'Apple iPhone Driver GPS Active'
                        : 'Android Driver Telemetry Active',
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Giga Ride Driver requires active, high-precision GPS to receive ride requests, display nearby passenger bids, calculate route fares, and ensure passenger safety.',
            textAlign: TextAlign.center,
            style: TextStyle(
              color: AppConstants.textMuted,
              fontSize: 13,
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (_isServiceDisabled) ...[
                    ...
                    _buildGuideStep(
                      step: '3',
                      title: 'Return to Giga Driver',
                      subtitle: 'The app will immediately detect the signal and unlock the radar.',
                    ),
                  ] else if (isApple) ...[
                    _buildGuideStep(
                      step: '1',
                      title: 'Tap "Open Device Settings" Below',
                      subtitle: 'Takes you straight to Giga Driver permissions in iOS Settings.',
                    ),
                    _buildGuideStep(
                      step: '2',
                      title: 'Tap "Location"',
                      subtitle: 'Select "Always" or "While Using the App".',
                    ),
                    _buildGuideStep(
                      step: '3',
                      title: 'Enable "Precise Location" (Mandatory for Drivers)',
                      subtitle: 'Ensures dispatch radar accurately routes nearby passenger trips.',
                    ),
                    _buildGuideStep(
                      step: '4',
                      title: 'Return to Giga Driver',
                    ...
                    _buildGuideStep(
                      step: '1',
                      title: 'Tap "Open Device Settings" Below',
                      subtitle: 'Takes you to Giga Driver Application Info in Android Settings.',
                    ),
                    _buildGuideStep(
                      step: '2',
                      title: 'Tap "Permissions" ➔ "Location"',
                      subtitle: 'Select "Allow all the time" or "Allow only while using the app".',
                    ),
                    _buildGuideStep(
                      step: '3',
                      title: 'Turn On "Use Precise Location"',
                      subtitle: 'Ensures high accuracy driver dispatch.',
                    ),
                    _buildGuideStep(
                      step: '4',
                      title: 'Return to Giga Driver',
                      subtitle: 'Giga Driver will instantly detect the permission and continue.',
                    ),
                  ],
                ],
              ),
